...
{
    public delegate void OnAddonReceiveEventDelegate(IntPtr atkUnit, ushort eventType, int which, IntPtr source, IntPtr data);

    public sealed class SelectStringReceiveEvent : SeFunctionBase<OnAddonReceiveEventDelegate>
    {
        public SelectStringReceiveEvent(SigScanner sigScanner)
            : base(sigScanner,
