...
namespace Peon.Gui
{
    public partial class TimerWindow
    {
        private struct StateInfo
        {
            ...
            public uint Color()
                => AllObjectsAvailable == TimeSpan.Zero ? GreenHeader : FirstObjectAvailable == TimeSpan.Zero ? YellowHeader : RedHeader;
            ...
            public static readonly StateInfo Empty = new(DateTime.UnixEpoch, Array.Empty<DateTime>(), false);
        ...
        private bool ColorHeader(string header, StateInfo infos)
        {
            ...
            var text = color switch
            {
                YellowHeader => TimeSpanString(infos.AllObjectsAvailable),
                RedHeader    => TimeSpanString(infos.FirstObjectAvailable),
                _      => string.Empty,
            };
        ...
        private ImGuiRaii SetupTable(string label, float width)
        {
